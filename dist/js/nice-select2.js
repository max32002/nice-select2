...
! function(e, t) {
	...
	function f(e, t) {
		...
		if(nice_select_2_instance.hasOwnProperty(e.id)) {
			if (nice_select_2_instance[e.id] != null) {
				instance = nice_select_2_instance[e.id];
			}
		}
		
		if (instance == null) {
			instance = new NiceSelect(e, t);
			nice_select_2_instance[e.id] = instance;
		}
		return instance;
	}
	return NiceSelect.prototype.create = function() {
	...
	}, NiceSelect.prototype.processData = function(e) {
		var t = [];
		e.forEach((e => {
			t.push({
				data: e,
	...
	}, NiceSelect.prototype._renderItem = function(e) {
	...
	}, NiceSelect.prototype._renderItemExtra = function(e) {
		...
		delete nice_select_2_instance[this.el.id];
	...
	}, NiceSelect.prototype._onItemClicked = function(e, t) {
		var i = t.target;
		...
		return !1
	}, NiceSelect.prototype._findNext = function(e) {
		for (e = e ? e.nextElementSibling : this.dropdown.querySelector(".list .option"); e;) {
			if (!a(e, "disabled") && "none" != e.style.display) return e;
			e = e.nextElementSibling
		}
		return null
	}, NiceSelect.prototype._findPrev = function(e) {
